...
public class ExampleMod : IGameMakerMod {
    ...
    public void Load(int audioGroup, UndertaleData data, ModData currentMod) {
        ...
        data.HookCode("gml_Object_obj_epilepsy_warning_Create_0",
            @"#orig#()
txt_1 = ""eat my nuts""");
...
txt_2 = config.text");
        ...
        data.HookCode("gml_Object_obj_player_Step_0",
            @"#orig#()
...
");
        ...
        data.HookAsm("gml_Object_obj_epilepsy_warning_Create_0", (code, locals) => {
...
//        data.HookFunction("scr_move_like_a_snail",
...
//");
        ...
        data.CreateGlobalScript("scr_setup_menu_example", "global.wys_test3 = false\nglobal.wys_test4 = 0.0",
            0, out _);

        UndertaleGameObject configMenu = data.CreateMenu("ExampleConfig",
            ...
            data.CreateToggleOption("\"Test Option 3\"", "test3",
            ...
            data.CreateChangeOption("\"Test Option 4\"", "test4",
